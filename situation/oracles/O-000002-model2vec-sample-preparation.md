...
| P4 | TypeScript, Swift, and Kotlin explicit activation is manual; required Rust input is decided | manual (optional-source activation); `tests/benchmarks/test_model2vec_prepare.py::test_resolve_inputs_missing_rust_is_config_error` |
...
| F4 | Implicit TypeScript, Swift, or Kotlin contribution is manual; missing Rust input is detected | manual (implicit optional-source contribution); `tests/benchmarks/test_model2vec_prepare.py::test_resolve_inputs_missing_rust_is_config_error` |
